...
class ListSubaccountsResponseSubAccountsItem extends JsonSerializableType
{
    /**
     * @var string $name
     */
     ...
     * ) $permissions
     */
    #[JsonProperty('permissions'), Union(new Union('mixed', 'null'), ListSubaccountsResponseSubAccountsItemPermissionsCalls::class)]
