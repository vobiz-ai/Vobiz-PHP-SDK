...
class SpeakTextClient
{
     ...
     * @param SpeakTextCallRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function call(string $authId, string $callUuid, SpeakTextCallRequest $request, ?array $options = null): void
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    ...
                    path: "api/v1/Account/{$authId}/Call/{$callUuid}/Speak/",
     ...
     * @throws VobizApiException
     */
    public function stopSpeakCall(string $authId, string $callUuid, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
