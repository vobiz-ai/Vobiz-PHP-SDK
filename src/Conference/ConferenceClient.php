...
use Vobiz\Conference\Requests\PlayAudioMemberRequest;
...
class ConferenceClient
{
     ...
     */
    public function kickMember(string $authId, string $conferenceName, string $memberId, ?array $options = null): mixed
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    ...
                    path: "api/v1/Account/{$authId}/Conference/{$conferenceName}/Member/{$memberId}/Kick/",
     ...
     * @throws VobizApiException
     */
    public function hangupMember(string $authId, string $conferenceName, string $memberId, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "api/v1/Account/{$authId}/Conference/{$conferenceName}/Member/{$memberId}/",
     ...
     * @param string $conferenceName
     * @param string $memberId
     * @param PlayAudioMemberRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function playAudioMember(string $authId, string $conferenceName, string $memberId, PlayAudioMemberRequest $request, ?array $options = null): mixed
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "api/v1/Account/{$authId}/Conference/{$conferenceName}/Member/{$memberId}/Play/",
                    method: HttpMethod::POST,
                    body: $request,
                ),
                $options,
     ...
     * @throws VobizApiException
     */
    public function stopAudioMember(string $authId, string $conferenceName, string $memberId, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
    ...
    public function deafMember(string $authId, string $conferenceName, string $memberId, ?array $options = null): mixed
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "api/v1/Account/{$authId}/Conference/{$conferenceName}/Member/{$memberId}/Deaf/",
                    method: HttpMethod::POST,
                ),
                $options,
            );
     ...
     * @throws VobizApiException
     */
    public function undeafMember(string $authId, string $conferenceName, string $memberId, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
