...
use DateTime;
use Vobiz\Cdr\Types\SearchCdrsRequestCallDirection;

class SearchCdrsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<SearchCdrsRequestCallDirection> $callDirection Filter by direction.
     */
     ...
     *   startDate?: ?DateTime,
     *   endDate?: ?DateTime,
     *   callDirection?: ?value-of<SearchCdrsRequestCallDirection>,
     *   minDuration?: ?int,
     *   page?: ?int,
     *   perPage?: ?int,
     * } $values
